                ...
                >
                    {skills?.data?.map((skill: any, index: any) => (
                        <motion.div
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-md rounded-xl p-2 sm:p-3 md:p-4 shadow-md hover:shadow-lg transition-all duration-300 flex flex-row items-center justify-between gap-3 sm:gap-4 cursor-pointer border border-gray-200/20 dark:border-gray-700/20"
                        >
